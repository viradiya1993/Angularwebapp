...
export class TaskDialogeComponent implements OnInit {
  ...
  UserDropDownData: any;
    ...
    ForCommonNewData(){
      ...
      // this.TaskForm.controls['REMINDER'].disable();
    ...
    //    this.TaskForm.controls['REMINDERTIME'].setValue(this.f.SendREMINDERTIME.value);
    //    this.TaskForm.controls['SendREMINDERTIME'].setValue(this.time);
    //   this.TaskForm.controls['REMINDERDATE'].setValue(this.f.SendREMINDERDATE.value);
    //    this.TaskForm.controls['SendREMINDERDATE'].setValue(this.datepipe.transform(new Date(), 'dd/MM/yyyy'));
    //  }
